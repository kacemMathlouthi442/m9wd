...
DATABASE_URL = 'postgresql://postgres.wvhccgiprcxiicmlcten:m9wdusers12.@aws-1-us-east-2.pooler.supabase.com:6543/postgres'
# -------------------------------
# 🧩 CONNECTION SETUP
# -------------------------------
...
KEY_TYPES = {'3 months', '1 day', '2 days', '1 week', '1 month'}

DURATION_MAP = {
    '3 months': (timedelta(days = 90), '3 Months'),
    '1 day': (timedelta(days=1), '1 Day'),
    '2 days': (timedelta(days=2), '2 Days'),
